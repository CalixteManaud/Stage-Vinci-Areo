...
text_info = "Pour v�rifier un afficheur, si vous mettez 1 l'afficheur s'allume, en revanche si c'est 0, cela sera " \
            "�teint"
text3 = "Certaines valeurs ne marchent pas nous allons le r�gler dans la prochaine version"
text_reponse = "Regarder votre FCU un bouton vient d'�tre allum�"
...
while True:
    try:
        ...
        # dev.write(0x1, arr)
        # Inverse la valeur des bits envoy�s
        arr = [0x43, 0x09, 0x00]
        dev.write(0x1, arr)
